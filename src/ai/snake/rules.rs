...
fn ban_move_if_left_column_locked(board: Board, direction: Move) -> Option<Move> {
...
fn ban_move_if_breaks_monotonicity_of_left_column(
    engine: &GameEngine,
    board: Board,
    direction: Move,
) -> Option<Move> {
...
fn try_move_if_produces_left_merge(
    engine: &GameEngine,
    board: Board,
    direction: Move,
) -> Option<Move> {
...
fn try_move_if_moves_largest_tile_to_bottom_left_corner(
    engine: &GameEngine,
    board: Board,
    direction: Move,
) -> Option<Move> {
