...
fn _greedy_prioritise_best<T: GameEngine>(
    ...
    loop {
        ...
        let max_try_length_reached = best_snake_data.strategy.try_rules.len() >= max_try_length;
        let max_ban_length_reached = best_snake_data.strategy.ban_rules.len() >= max_ban_length;
